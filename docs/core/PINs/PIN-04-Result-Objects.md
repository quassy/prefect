...
Accepted; furthers the objectives of [PIN-2](/core/PINs/PIN-02-Result-Handlers/)
...
To be clear, this PIN represents an evolution of the mechanisms introduced by [PIN-2](/core/PINs/PIN-02-Result-Handlers/). It represents the same logic, just refactored with the benefit of seeing it in action.
