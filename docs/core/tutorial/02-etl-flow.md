...
In this tutorial, we'll use Prefect to improve the overall structure of the ETL workflow from the [previous tutorial](/core/tutorial/01-etl-before-prefect/).
...
![Graph ETL](/img/prefect-tutorial-etl-dataflow.png)
